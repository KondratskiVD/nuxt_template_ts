    ...
    <template v-slot:default>
      <div class="border-t border-gray-200 flex px-4 py-4 sm:px-6 bg-white">
        <p class="text-sm leading-5 text-gray-500">
          К вам на уборку приезжает один клиннер &#128129;&#8205;&#9792;&#65039; ‍♀️(только женщины). <br>
          Мы берем с собой всю химию, губки, салфетки, мопы, швабру, ведро.<br>
          От вас просим только пылесос и какую-то устойчивую поверхность (стресянка, стул, стол...)&#128591;<br>
          &#127384;️ В уборке есть ограничения: мы не моем люстры, стены, потолки, не двигаем тяжелые предметы.
        </p>
      </div>
      <ul>
        <li
