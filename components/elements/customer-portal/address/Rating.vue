<template>
  <div>
    <div class="flex flex-col-reverse sm:flex-row items-end sm:items-center">
      ...
      <svg class="flex-shrink-0 inline sm:mr-1 h-6 w-6 cursor-pointer text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div v-if="showModal === true" class="modal-mask">
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
          <div style="z-index: 1100" class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div v-if="order.review == null" class="mt-3 sm:mt-0 sm:ml-4 sm:text-left w-full">
                <h3 class="sm:text-lg text-sm leading-6 font-medium text-gray-900 flex justify-between">
                  <span>
                    Оставьте пожалуйста ваш отзыв
                  </span>
                  <span @click="showModal = false; boundRating = 0">
                    <svg class="cursor-pointer flex-shrink-0 float-right h-6 w-6 text-gray-400 bg-gray-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div v-else class="mt-3 sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div class="mt-2">
                  <div class="space-y-1">
                    <p class="text-sm leading-5 text-gray-500 pesponsive-text">
                  ...
                  <p class="mt-2 text-sm text-gray-500">
                    <svg class="flex-shrink-0 inline mr-1 h-6 w-6 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  setup (props, context: SetupContext) {
    ...
    async function sendRating () {
      ...
      try {
        ...
        // context.root.$store.dispatch('ui/refreshPage')
      }
    }
    function resetForm () {
      $v.value.$reset()
    ...
    return { sentRating, showModal, comment, $v, boundRating, isLoading, notify }
  }
})
</script>
